...
`,C=()=>{const e=(0,i.I0)(),t=(0,r.useRef)(),n=(0,i.v9)((e=>e?.user)),a=(0,r.useMemo)((()=>()=>{e({type:"SET_USER_NAME",name:t.current.value})}),[]);return o().createElement(w,null,o().createElement("h1",null,"Root App Home Page"),o().createElement("h2",null,"Logged in user: ",n?.name),o().createElement("input",{type:"text",ref:t}),o().createElement("button",{onClick:a},"Set User"))};var j=n(265),R=n.n(j);const P=o().lazy((()=>n.e(428).then(n.t.bind(n,428,23)))),k=({store:e})=>{const t=(0,i.v9)((e=>e?.user));return o().createElement(r.Fragment,null,o().createElement(c.AW,{exact:!0,path:"/"},o().createElement(C,null)),o().createElement(c.AW,{path:"/orders/"},o().createElement(P,{store:e})),t?.isConnected&&o().createElement(c.AW,{path:"/delivery/"},o().createElement(R(),{storeName:"Global Store"})))},N=function(){const e=("object"==typeof window&&window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__?window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__({}):v.qC)(),t=(0,v.MT)(O(),e);return t.asyncReducers={},t.injectReducer=(e,n)=>{t.asyncReducers[e]=n,t.replaceReducer(O(t.asyncReducers))},t}(),U=()=>o().createElement(i.zt,{store:N},o().createElement(_,null),o().createElement(a.VK,null,o().createElement(E,{sitename:"Infinity"}),o().createElement(h,null),o().createElement(x,null,o().createElement(o().Suspense,{fallback:"Loading"},o().createElement(c.rs,null,o().createElement(k,{store:N}))))));var T=n(351);n.n(T)().render(o().createElement(U,null),document.getElementById("root"))}}]);
